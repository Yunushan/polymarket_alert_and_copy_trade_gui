...
| SX Bet / SX Network (`sx_bet`) | Implemented | Yes | Yes | Yes (public trades plus API-key account bets/fills/positions) | Guarded, off by default (v3 order/event/all cancellation) | No | Required | API credentials required | Jurisdiction varies |
