...
| XO Market (`xo_market`) | Implemented | Yes | Yes (public trades/candles; authenticated account trades, positions, orders, settlement, audit) | Yes | Guarded, off by default (cancel also guarded) | No | Required | API credentials required | Region/KYC limited |
