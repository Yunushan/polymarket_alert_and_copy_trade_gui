...
| Smarkets (`smarkets`) | Implemented | Yes | Yes (authenticated orders/account, executed trades, bounded derived candles) | Yes | Guarded place/cancel, off by default | No | Required | Exchange account/API keys | Region/KYC limited |
