...
- Omen/Gnosis, Manifold, DFlow, Betfair, Matchbook, and SX Bet candle responses are bounded, explicitly marked as derived, and retain source trade/fill/execution ids because those public/account feeds do not expose native candle endpoints. Omen/Gnosis candle derivation rejects same-second trades with different prices because the subgraph does not expose a block/log ordering key.
