...
| Trueo (`trueo`) | Implemented | Yes | Yes (V3/V4 prices, bounded public swaps, and derived candles) | Yes | Guarded, off by default | No | Required | Production Base RPC and externally signed wallet transaction required for live orders | Jurisdiction varies |
