...
- Manifold, DFlow, Betfair, Matchbook, and SX Bet candle responses are bounded, explicitly marked as derived, and retain source trade/fill/execution ids because those public/account feeds do not expose native candle endpoints.
